...
def candidates(c,req,hotel,d,desired,used,route_cache=None):
...
def weather_priority(r,req,d):
    ...
    if mode=="rainy":
        ...
        if is_indoor(r): bonus += 22
        if any(k in tags(r) for k in ["museums","crafts","winery","local_food","wellness"]): bonus += 18
    else:
